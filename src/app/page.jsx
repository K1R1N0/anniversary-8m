...
const ANNIVERSARY_DATE = "2025-12-29T00:00:00"
// Change this to the date you got together
const TOGETHER_DATE = "2025-04-29T00:00:00"
...
export default function Home() {
  ...
  const photos = [
    { src: "/us.jpg", alt: "Us together" },
    { src: "/love.jpg", alt: "Special moment" },
    { src: "/rak.jpg", alt: "Happy times" },
    { src: "/besttime.jpg", alt: "Memories" },
  ]
        ...
        {loading ? (
          ...
          <>
            ...
            >
              ...
              >
                <p className="text-lg font-medium">Made with ❤️ by the future husband Naprapat</p>
              </motion.footer>
            </motion.div>
          </>
        )}
